...
describe( 'createClipPathElement', () => {
	...
	beforeEach( () => {
		sourceElement = createXmlElement( 'rect', { id: 'source', width: 10, height: 10, x: 5, y: 5 } ) as SVGRectElement;
		targetAElement = createXmlElement( 'rect', { id: 'target-a', width: 10, height: 10, x: 5, y: 5 } ) as SVGRectElement;
		targetBElement = createXmlElement( 'rect', { id: 'target-b', width: 10, height: 10, x: 5, y: 5 } ) as SVGRectElement;
